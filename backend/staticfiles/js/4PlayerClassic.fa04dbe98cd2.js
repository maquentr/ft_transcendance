...
let Game = {
    initialize: function(goal){
        ...
        this.player1 = Player.new.call(this, '#ffffff', 'Jean', 'left');
        this.player2 = Player.new.call(this, '#ffffff', 'Sarkozy', 'up');
        this.player3 = Player.new.call(this, '#ffffff', 'Balkany', 'right');
        this.player4 = Player.new.call(this, '#ffffff', 'Macron', 'down');
    ...
    listen: function () {
        ...
        document.addEventListener('keydown', function (key)
        {
            ...
            if (key.keyCode === 74) Pong.player4.move = DIRECTION.LEFT;
            ...
            if (key.keyCode === 78 ) Pong.player4.move = DIRECTION.RIGHT;
...
function start4PlayerClassic(goal)
{
    Pong = Object.assign({}, Game);
    Pong.initialize(goal);
}

export {start4PlayerClassic};