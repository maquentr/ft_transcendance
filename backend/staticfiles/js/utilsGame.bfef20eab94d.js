...
// Not use and does NOT work. Working on implement it 
...
{
    if (!key.ctrlKey && !key.altKey && !key.shiftKey && !key.metaKey && key.key !== "Escape") 
    {
...
function    createMenu(container, nbOfMenus)
{
    ...
    for (let i = 1; i <= nbOfMenus; i++)
    {
        ...
        const selectPow = createSelect(`powerUpP${i}`);
...
export {createMenu, createButton, createInput, createLabel, formatDate, quitGame};
