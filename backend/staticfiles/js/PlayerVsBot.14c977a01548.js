...
// rounds and colors are temporary until we can play 1vs1. Allow me to test if the code is working 
    ...
    update: function () {
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () { Pong.endGameMenu('Winner! But take it easy'); }, 1000);
            } else {
        ...
        // Check to see if the ai/AI has won the round.
            ...
            this.over = true;
            setTimeout(function () { Pong.endGameMenu('Game Over! U lose againts a STUPID bot'); }, 1000);
        }
    },
...
function startGaming()
{
    ...
    p.innerText = "Up: W or up arrow       Down: S or down arrow";
    p.style.color= 'RED';
